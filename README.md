## Acesso inicial automático

Este projeto inclui uma migration que cria/atualiza automaticamente um superusuário padrão durante `python manage.py migrate`:

- **Usuário:** `admin`
- **Senha:** `12345678`

> O login é por **usuário**, não por e-mail. Após entrar, altere a senha no painel de usuários.
